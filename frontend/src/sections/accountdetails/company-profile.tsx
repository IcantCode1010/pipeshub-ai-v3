                ...
                >
                  ...
                  <Grid container spacing={2.5}>
                    ...
                    <Grid item xs={12} sm={6}>
                      <Tooltip
                        title="The name of the company to display within Aerointel Solutions"
                        arrow
                        placement="top-start"
                      >
                        <Box>
                ...
                >
                  ...
                  <Box>
                    <Typography variant="body2" sx={{ color: theme.palette.text.secondary, mb: 1 }}>
                      Aerointel Solutions collects and processes personal information for a variety of business
                      purposes.
                    </Typography>
